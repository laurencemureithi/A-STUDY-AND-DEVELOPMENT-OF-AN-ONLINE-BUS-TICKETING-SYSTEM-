 <section id="bg-bus" style=" z-index:2;padding-left:200px; position:absolute;" class="d-flex align-items-center">
<main id="main">
	<div class="container">
		<div class="col-lg-12">
			...
			<div class="row">
				<div class="card col-md-12">
					<div class="card-header">
						<div class="card-title">Location List: Set your Stage Terminus Here</div>
					</div>
					<div class="card-body">
